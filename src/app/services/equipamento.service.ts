...
export class EquipamentoService {
  ...
  updateEquipamento(equipamento: Equipamento): Observable<any> {
    ...
    let url = `${this.equipamentoUrl}/atualizar`;
    return this.http.post<EntidadeResponse<Equipamento>>(url, u.toString(), this.httpOptions)
  ...
  deleteEquipamento(id: Number): Observable<any> {
    let url = `${this.equipamentoUrl}/remover`;
    let u = new URLSearchParams();
